...
void CClantagChanger::UpdateClanTagCallback()
{
	...
	CClantagChanger::animations = {
		CClantagChanger::Marquee(charenc("ENSNARE.cc"), charenc("ENSNARE.cc")),
		CClantagChanger::Words(charenc("ENSNARE.cc"), charenc("ENSNARE.cc")),
		CClantagChanger::Letters(charenc("ENSNARE.cc"), charenc("ENSNARE.cc"))
	};
